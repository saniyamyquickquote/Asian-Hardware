...
export default function Login({ onLogin }) {
  ...
  return <div className="login-page"><div className="login-art" role="img" aria-label="Hardware store interior"><img src="/images/interior.jpg" alt="Illustration of a well-stocked hardware store"/><div className="login-art-copy"><span className="eyebrow">ASIAN HARDWARE & PAINTS</span><h1>Your store.<br/>In control.</h1><p>From the counter to the stockroom, everything in one place.</p></div></div>
